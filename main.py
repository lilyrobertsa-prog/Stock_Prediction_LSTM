...
df, X_train_raw, X_test_raw, y_train_raw, y_test_raw = add_features(df, TOP_FEATURES, TRAIN_SPLIT = 0.8)
...
train_rmse_lin, test_rmse_lin, direction_accuracy_lin = evaluate_predictions(y_train_pred_lin, y_test_pred_lin, y_train_raw, y_test_raw)
print(f"train rmse linear: {train_rmse_lin} test_rmse linear: {test_rmse_lin}, directional accuracy linear: {direction_accuracy_lin}")

#need tuple
#train_rmse, test_rmse, direction_accuracy = evaluate_predictions(y_train_pred, y_test_pred, y_train_raw, y_test_raw)
#print(f"train rmse is{train_rmse}, test rmse is {test_rmse}, directional accuracy is {direction_accuracy}")
...
train_rmse_l, test_rmse_l, direction_accuracy_l = evaluate_predictions(y_train_pred, y_test_pred, y_train_actual, y_test_actual)
print(f"train rmse lstm: {train_rmse_l} test_rmse lstm: {test_rmse_l}, directional accuracy lstm: {direction_accuracy_l}")
